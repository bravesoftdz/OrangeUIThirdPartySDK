...
import com.example.sangforauthdemo.R;
...
public class MainActivity extends Activity implements View.OnClickListener, IVpnDelegate {
    private static final String TAG = "OrangeUI";//MainActivity.class.getSimpleName();

    // 请在这里定义具体参数
    private static final String VPN_IP = "120.36.63.1";
    private static final String USER = "350128199010200114";
    private static final String PASSWD = "zst350400";
    private static final String HTTP_RES = "http://11.0.11.13:1880";
...
//        if (browser!=null)
//        {	
//        	Log.w(TAG, "browser is not null");
//        	browser.loadUrl("http://www.baidu.com");
//        } 
//        else
//        {
//        	Log.w(TAG, "browser is null");
//        }
