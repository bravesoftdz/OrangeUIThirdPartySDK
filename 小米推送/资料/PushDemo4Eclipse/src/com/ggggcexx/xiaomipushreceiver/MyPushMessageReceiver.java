...
public class MyPushMessageReceiver extends PushMessageReceiver {
	...
	public static void setOnMyPushMessageListener(OnMyPushMessageListener Listener)
	{
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        ...
        if (mListener!=null)
        {
        	...
        	mListener.onReceivePassThroughMessage(context,message);
    ...
    public void onNotificationMessageClicked(Context context, MiPushMessage message) {
        ...
        if (mListener!=null)
        {
        	...
        	mListener.onNotificationMessageClicked(context,message);
    ...
    public void onNotificationMessageArrived(Context context, MiPushMessage message) {
        ...
        if (mListener!=null)
        {
        	...
        	mListener.onNotificationMessageArrived(context,message);
    ...
    public void onCommandResult(Context context, MiPushCommandMessage message) {
        ...
        if (mListener!=null)
        {
        	...
        	mListener.onCommandResult(context,message);
    ...
    public void onReceiveRegisterResult(Context context, MiPushCommandMessage message) {
        ...
        if (mListener!=null)
        {
        	...
        	mListener.onReceiveRegisterResult(context,message);
