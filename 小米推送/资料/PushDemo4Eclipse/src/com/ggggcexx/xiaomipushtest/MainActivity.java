...
import com.ggggcexx.xiaomipushtest.TimeIntervalDialog.TimeIntervalInterface;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.set_alias).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.set_alias).setView(editText)
		...
		findViewById(R.id.unset_alias).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.unset_alias).setView(editText)
						.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.set_account).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.set_account).setView(editText)
						.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.unset_account).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.unset_account).setView(editText)
						.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.subscribe_topic).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.subscribe_topic).setView(editText)
						.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.unsubscribe_topic).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.unsubscribe_topic).setView(editText)
						.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
